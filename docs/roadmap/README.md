...
| **J3** | La **facture comptable** sort : 3 pages, 60 lignes, totaux reportés, mentions au bon endroit, en français/euros puis anglais/dollars. La pagination et l'en-tête répété sont livrés ([ADR 0013](../adr/0013-le-tableau-deborde-proprement.md)) ; les reports, les mentions de dernière page et les deux langues restent à faire | [engine](engine.md) |
